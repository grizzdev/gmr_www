				...
				<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
					...
					<tr class="mobile_only">
						<td class="w640" width="640" align="center">
							<img class="mobile_only" border="0" src="{{ $message->embed(public_path().'/img/logo.png') }}" alt="Gamerosity" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" />
						</td>
					</tr>
					<tr class="mobile_only">
						<td class="w640" height="10" width="640"></td>
							...
							<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
								<tr>
									...
									<td id="logo" width="{{ $logo['width'] }}" valign="top">
										<img border="0" src="{{ $message->embed(public_path().'/img/logo.png') }}" alt="Gamerosity" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" />
									</td>
								...
								<tr>
									...
									<td valign="top">
										<table align="right">
											...
											<tr>
												@if (!empty(config('mail.view.twitter')))
													<td><a href="http://twitter.com/{{ config('mail.view.twitter') }}"><img src="{{ $message->embed(public_path().'/img/twitter.png') }}" alt="Twitter" height="25" width="25" style="border:0" /></a></td>
												@endif

												@if (!empty(config('mail.view.facebook')))
													<td><a href="http://facebook.com/{{ config('mail.view.facebook') }}"><img src="{{ $message->embed(public_path().'/img/fb.png') }}" alt="Facebook" height="25" width="25" style="border:0" /></a></td>
												@endif
											</tr>
										</table>
									</td>
